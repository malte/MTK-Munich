...
<CurvedHeadline tag="h4" type="quarter" direction="L2R" offset="0" class="top-[30px] sm:top-[-150px] fill-lazuli">Absolutely everything! - What is good for?</CurvedHeadline>
...
<CurvedHeadline tag="h4" type="kicker" direction="R2L" offset="40" class="sm:top-[-300px]  fill-lazuli">The Ma Tsun Kuen System</CurvedHeadline>
...
<CurvedHeadline tag="h2" type="smile" direction="R2L" offset="0" class="sm:top-[-200px]  fill-terracotta">For whom ? For Everybody !</CurvedHeadline>
