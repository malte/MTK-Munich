...
<CurvedHeadline tag="h2" type="wave" direction="L2R" offset="2" class="sm:top-[-100px]  fill-terracotta">What we practice:</CurvedHeadline>
...
<Card title="1º Student - brown" meta="min. 5 years of practice" color="amber-900 text-stone-100">
...
<Card title="1st Tuan  -  black" meta="min. 7 years of practice" color="stone-800 text-stone-100">

Repeat all of the above on a higher level.

</Card>

<Card title="2nd Tuan  -  black" meta="when master decides" color="stone-800 text-stone-100">
...
<Card title="3rd Tuan  -  black" meta="when master decides" color="stone-800 text-stone-100">

###### San Shou Tui Ta
The fighting form is a partner form examines martial aspects of Tai Chi Chuan.
</Card>

<Card title="4rd Tuan  -  black" meta="when master decides" color="stone-800 text-stone-100">
...
<Card title="5rd Tuan  -  black" meta="when master decides" color="stone-800 text-stone-100">
