...
<CurvedHeadline tag="h2" type="frown" direction="R2L" offset="50" class="sm:top-[-20px]  fill-terracotta">What we practice:</CurvedHeadline>
...
<Card title="5º Student - yellow" meta="min. 3 month of practice" class="bg-yellow-300">
###### Standing Practice
...
<Card title=" 4º Student - orange" meta="min. 9 month of practice" class="bg-amber-400">
...
<Card title="3º Student - green" meta="min. 18 month of practice" class="bg-green-500">
...
<Card title=" 2º Student - blue" meta="min. 3 years of practice" class="bg-blue-500">
...
<Card title="1º Student - brown" meta="min. 5 years of practice" class="bg-amber-900 text-stone-100">
...
<Card title="1st Tuan  -  black" meta="min. 7 years of practice" class="bg-stone-800 text-stone-100">

Repeat all of the above on a higher level.

</Card>

<Card title="2nd Tuan  -  black" meta="when master decides" class="bg-stone-800 text-stone-100">
...
<Card title="3rd Tuan  -  black" meta="when master decides" class="bg-stone-800 text-stone-100">

###### San Shou Tui Ta
The fighting form is a partner form examines martial aspects of Tai Chi Chuan.
</Card>

<Card title="4rd Tuan  -  black" meta="when master decides" class="bg-stone-800 text-stone-100">
...
<Card title="5rd Tuan  -  black" meta="when master decides" class="bg-stone-800 text-stone-100">
