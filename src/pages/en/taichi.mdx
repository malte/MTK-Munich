...
The Tai Chi Classics is a collection of writings that have been attributed to the legendary founder of Tai Chi Chuan, Chang San Feng. They are a set of principles that guide the practice and understanding of Tai Chi Chuan. You can find an overview [here](http://www.scheele.org/lee/classics.html)
